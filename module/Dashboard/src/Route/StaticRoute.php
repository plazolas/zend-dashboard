...
class StaticRoute implements RouteInterface
{
    ...
    {
        // Oz - notes
        // Service Manager creates the instance with module.config.php parameter options at
        // Zend\ServiceManager\ServiceManager->doCreate( )
        //throw new Exception\InvalidArgumentException(__CLASS__.__METHOD__."HERE");
    ...
    public function match(Request $request, $pathOffset = null)
    {
        ...
        // Zend\Router\Http\TreeRouteStack->match( )
        ...
        $routeMatch =  new RouteMatch(
                ...
                $matchedLength);
        $routeMatch->setMatchedRouteName('static');
